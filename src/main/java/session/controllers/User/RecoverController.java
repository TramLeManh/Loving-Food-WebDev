...
public class RecoverController {
    ...
    public RecoverController(OtpService otpService) {
    ...
    public String verifyOTP(HttpSession session, @PathVariable String sessionToken, RedirectAttributes redirectAttributes, Model model, @PathVariable String actionType) {
    ...
    public String resetPassword(HttpSession session, @PathVariable String sessionToken, Model model) {
        try {
            String token = (String) session.getAttribute("sessionToken");
